 ...
 * API Room Platform.
 */
const ApiRoom = ({ active, focused, exploreMode, onSelect, onPortalComplete, children }) => {
  const groupRef = useRef();
  ...
  useFrame((state) => {
    if (wireframeRef.current) {
      ...
      wireframeRef.current.rotation.z = time * rotSpeed;
    }
  });
  ...
  useEffect(() => {
    ...
    if (active) {
      ...
      // Sinks slightly deeper because it's further away
      targetY = -0.45;
      targetPlatformOpacity = 0.35; // Faded because it's far away
      targetBorderOpacity = 0.25;
      targetScale = 0.55;
      targetLightIntensity = 0.7;
      targetTextOpacity = 0.45;
      targetParticlesOpacity = 0.15;
    }
  ...
  return (
    ...
    >
      ...
      <Portal 
        ...
        onComplete={() => onPortalComplete && onPortalComplete("api-flow")} 
      />
